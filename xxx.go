...
type BasicSquash struct {
	Test Basic `mapstructure:"profile.out,saf,omitempty,squash"`
}
...
func (c *Tesss) Error(format string) {
	fmt.Printf(format)
}

func (c *Tesss) Fatal(format string) {
	fmt.Printf(format)
}

func (c *Tesss) Errorf(format string, args ...any) {
	fmt.Printf(format, args...)
}

func (c *Tesss) Fatalf(format string, args ...any) {
	fmt.Printf(format, args...)
}

func (c *Tesss) FailNow() {}

func TestBasicTypes(t *Tesss) {
	var vvvv = []byte("xxxxx")
	var ret []int8
...
func TestBasic_IntWithFloat(t *Tesss) {
...
func TestBasic_interfaceStruct(t *Tesss) {
	...
	err := mapstructure.Decode(input, &iface)
	if err != nil {
		t.Fatalf("got an err: %s", err)
	}
...
// Issue 187
func TestBasic_interfaceStructNonPtr(t *Tesss) {
...
func TestDecode_BasicSquash(t *Tesss) {
...
func TestDecodeFrom_BasicSquash(t *Tesss) {
...
func TestDecode_Embedded(t *Tesss) {
...
func TestDecode_EmbeddedPointer(t *Tesss) {
...
func TestDecode_EmbeddedSlice(t *Tesss) {
	...
	if !reflect.DeepEqual(result.XXXXX, XXXXX([]string{"foo", "bar"})) {
		t.Errorf("slice value: %#v", result.XXXXX)
	}
...
func TestDecode_EmbeddedArray(t *Tesss) {

	input := map[string]interface{}{
		"xxxx":    [2]string{"foo", "bar"},
		"vunique": "bar",
	}
...
func TestDecode_decodeSliceWithArray(t *Tesss) {
...
func TestDecode_EmbeddedNoSquash(t *Tesss) {
...
func TestDecode_EmbeddedPointerNoSquash(t *Tesss) {
...
func TestDecode_EmbeddedSquash(t *Tesss) {
...
func TestDecodeFrom_EmbeddedSquash(t *Tesss) {
...
func TestDecode_EmbeddedPointerSquash_FromStructToMap(t *Tesss) {
...
func TestDecode_EmbeddedPointerSquash_FromMapToStruct(t *Tesss) {
...
func TestDecode_EmbeddedPointerSquashWithNestedMapstructure_FromStructToMap(t *Tesss) {
...
func TestDecode_EmbeddedPointerSquashWithNestedMapstructure_FromMapToStruct(t *Tesss) {
...
func TestDecode_EmbeddedSquashConfig(t *Tesss) {
...
func TestDecodeFrom_EmbeddedSquashConfig(t *Tesss) {
...
func TestDecodeFrom_EmbeddedSquashConfig_WithTags(t *Tesss) {
...
func TestDecode_SquashOnNonStructType(t *Tesss) {
...
func TestDecode_DecodeHook(t *Tesss) {
...
func TestDecode_DecodeHookType(t *Tesss) {
...
func TestDecode_NilInterfaceHook(t *Tesss) {
...
func TestDecode_NilPointerHook(t *Tesss) {
...
func TestDecode_FuncHook(t *Tesss) {
...
func TestDecode_NonStruct(t *Tesss) {
...
func TestDecode_StructMatch(t *Tesss) {
...
func TestDecode_TypeConversion(t *Tesss) {
	input := map[string]interface{}{
		"IntToFloat":         42,
		"IntToUint":          42,
		"IntToBool":          1,
	...
	err := mapstructure.Decode(input, &resultStrict)
	if err == nil {
...
func TestDecoder_ErrorUnused(t *Tesss) {
...
func TestDecoder_ErrorUnused_NotSetable(t *Tesss) {
...
func TestDecoder_ErrorUnset(t *Tesss) {
...
func TestNestedTypePointer(t *Tesss) {
...
// Test for issue #46.
func TestNestedTypeInterface(t *Tesss) {
...
func TestSliceOfStruct(t *Tesss) {
...
func TestSliceCornerCases(t *Tesss) {

	// Input with a map with zero values
	input := map[string]interface{}{}
	var resultWeak []Basic

	err := mapstructure.WeakDecode(input, &resultWeak)
	if err != nil {
		t.Fatalf("got unexpected error: %s", err)
	}
...
func TestArrayOfStruct(t *Tesss) {
...
func TestDecodeTable(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := mapstructure.Decode(tt.in, tt.target); (err != nil) != tt.wantErr {
...
func TestInvalidType(t *Tesss) {
	...
	derr, ok := err.(*mapstructure.Error)
	if !ok {
	...
	err = mapstructure.Decode(inputNegIntUint, &result)
	if err == nil {
		t.Fatal("error should exist")
	}
	...
	err = mapstructure.Decode(inputNegFloatUint, &result)
	if err == nil {
		t.Fatal("error should exist")
	}
...
func TestDecodeMetadata(t *Tesss) {
	...
	err := mapstructure.DecodeMetadata(input, &result, &md)
	if err != nil {
...
func TestMetadata_Embedded(t *Tesss) {
...
func TestNonPtrValue(t *Tesss) {

	err := mapstructure.Decode(map[string]interface{}{}, Basic{})
	if err == nil {
		t.Fatal("error should exist")
	}
...
func TestWeakDecodeMetadata(t *Tesss) {
	...
	if err := mapstructure.WeakDecodeMetadata(input, &result, &md); err != nil {
		t.Fatalf("err: %s", err)
	}
	if result.Foo != 4 {
		t.Fatalf("bad: %#v", result)
...
func TestDecode_StructTaggedWithOmitempty_OmitEmptyValues(t *Tesss) {
	...
	mapstructure.Decode(input, actual)
...
func TestDecode_StructTaggedWithOmitempty_KeepNonEmptyValues(t *Tesss) {
...
func TestDecode_mapToStruct(t *Tesss) {
	type Target struct {
		String    string
		StringPtr *string
	}
...
func TestDecoder_MatchName(t *Tesss) {
	type Target struct {
...
func TestDecoder_IgnoreUntaggedFields(t *Tesss) {
	type Input struct {
		UntaggedNumber int
...
func testSliceInput(t *Tesss, input map[string]interface{}, expected *Slice) {
	var result Slice
	err := mapstructure.Decode(input, &result)
	if err != nil {
		t.Fatalf("got error: %s", err)
...
func testArrayInput(t *Tesss, input map[string]interface{}, expected *Array) {
	var result Array
	err := mapstructure.Decode(input, &result)
	if err != nil {
		t.Fatalf("got error: %s", err)
